 ...
 * [br.com.olympus.hermes.notification.infrastructure.readmodel.NotificationView] documents in the read
...
interface NotificationViewRepository {
    ...
    fun findById(
        id: EntityId,
    ): Either<BaseError, br.com.olympus.hermes.notification.infrastructure.readmodel.NotificationView?>
     ...
     */
    fun upsert(
        view: br.com.olympus.hermes.notification.infrastructure.readmodel.NotificationView,
    ...
    fun findAll(
        ...
        BaseError,
        PaginatedResult<br.com.olympus.hermes.notification.infrastructure.readmodel.NotificationView>,
    >
