...
/**
 * Sealed interface representing the raw input data for notification creation. Each subtype
 * carries channel-specific primitive fields that will be validated and converted into
 * domain value objects by the corresponding [NotificationFactory].
 */
